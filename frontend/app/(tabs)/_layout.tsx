  ...
  return (
    <Tabs
      ...
      tabBar={(props) => {
        ...
        const tabBarWidth = SCREEN_WIDTH - 48; // Reduced width with 24px padding on each side
        ...
        return (
          ...
          >
            ...
            >
              ...
              {/* Simple bubble - no gradient, no blur */}
              <Animated.View
                pointerEvents="none"
                style={{
                  position: 'absolute',
                  ...
                  borderRadius: 29,
                  bottom: 6, // 6px from bottom
                  backgroundColor: colors['bg-primary'] + '20', // Simple solid color with opacity
                  transform: [
                    { 
              ...
              >
                {props.state.routes.map((route, index) => {
                  ...
                  return (
                    <Animated.View
                      key={route.key}
                      style={{ flex: 1, marginHorizontal: 2, transform: [{ scale }], minWidth: 0 }}
                    >
                      <View

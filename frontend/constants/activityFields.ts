...
export const ACTIVITY_FIELDS_BY_EVENT: Record<number, string[]> = {
  1: ["attempt_id", "time", "is_success"],  // SPEED
  2: ["attempt_id", "weight", "type_of_activity", "is_success"],  // WEIGHTED
  3: ["attempt_id", "time", "type_of_activity", "is_success"],  // MAX_HOLD
  4: ["attempt_id", "reps", "type_of_activity", "is_success"],  // MAX_REPS
};
